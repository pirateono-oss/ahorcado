...
export const metadata: Metadata = {
  title: 'Ahorcado — Juego de Adivinanza de Palabras',
  description: 'Juega al ahorcado online. Adivina palabras en español por categorías: animales, comidas, países, ciudades y naturaleza.',
};
